...
### 2) Download a BaseÂ Model
Training an object detector from scratch can take days, even when using multiple GPUs! In order to speed up training, weâ€™ll take an object detector trained on a different dataset, and reuse some of itâ€™s parameters to initialize our new model.
...
When you model is ready depends on your training data, the more data, the more steps youâ€™ll need. My model was pretty solid at ~4.5k steps. Then, at about ~20k steps, it peaked. I even went on and trained it for 200k steps, but it didnâ€™t get any better.
...
I recommend testing your model every ~5k steps to make sure youâ€™re on the right path.
...
## Results
Hereâ€™s what I got from running my model over all the frames in this clip from Star Wars: The Force Awakens.
